...
Data eviction from memory is triggered by the "ticking" process described in the [background processes section](/docs/v1.1/architecture/m3db/engine#background-processes)
