...
This guide shows you the steps involved in creating an M3 cluster using M3 binaries, typically you would automate this with infrastructure as code tools such as Terraform or [Kubernetes](/docs/v1.1/operator).

{{% notice note %}}
This guide assumes you have read the [quickstart](/docs/v1.1/quickstart/binaries), and builds upon the concepts in that guide.
{{% /notice %}}
...
Depending on the default limits of your bare-metal machine or VM, M3 may need some Kernel tweaks to run as efficiently as possible, and [we recommend you review those](/docs/v1.1/operational_guide/kernel_configuration) before running M3 in production.
...
{{% notice tip %}}
You can find more information on configuring M3DB in the [operational guides section](/docs/v1.1/operational_guide/).
{{% /notice %}}
