...
Double check your configuration against the [bootstrapping guide](/docs/v0.15.17/operational_guide/bootstrapping_crash_recovery). The nodes will log what bootstrapper they are using and what time range they are using it for.
...
2.  Check to make sure you are running adequate block sizes based on the retention of your namespace. See [namespace configuration](/docs/v0.15.17/operational_guide/namespace_configuration) for more information.
