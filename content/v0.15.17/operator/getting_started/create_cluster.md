...
Once you've [installed](/docs/v0.15.17/operator/getting_started/installation) the M3DB operator and read over the [requirements](/docs/v0.15.17/operator/getting_started/requirements), you can start
...
pod's UID will be used for its [identity][pod-identity]. The cluster will have 1 [namespace](/docs/v0.15.17/operator/configuration/namespaces) that stores
