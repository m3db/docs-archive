...
Before reading the rest of this document, we recommend familiarizing yourself with the [M3DB placement documentation](/docs/v0.15.17/operational_guide/placement).
...
If you find yourself adding or removing etcd seed nodes then we highly recommend setting up an [external etcd](/docs/v0.15.17/operational_guide/etcd) cluster, as
