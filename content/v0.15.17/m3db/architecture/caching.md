...
Data eviction from memory is triggered by the "ticking" process described in the [background processes section](/docs/v0.15.17/m3db/architecture/engine#background-processes)
