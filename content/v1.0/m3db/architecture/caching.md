...
Data eviction from memory is triggered by the "ticking" process described in the [background processes section](/docs/v1.0/m3db/architecture/engine#background-processes)
