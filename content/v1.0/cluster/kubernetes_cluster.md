...
{{% notice note %}}
This guide assumes you have read the [quickstart](/docs/v1.0/quickstart/docker), and builds upon the concepts in that guide.
{{% /notice %}}

{{% notice tip %}}
We recommend you use [our Kubernetes operator](/docs/v1.0/operator/operator) to deploy M3 to a cluster. It is a more streamlined setup that uses [custom resource definitions](https://kubernetes.io/docs/concepts/extend-kubernetes/api-extension/custom-resources/) to automatically handle operations such as managing cluster placements.
{{% /notice %}}
...
{{% notice tip %}}
[Read more about the bootstrapping process](/docs/v1.0/operational_guide/bootstrapping_crash_recovery/).
{{% /notice %}}
