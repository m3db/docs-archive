...
Yes, you can definitely do that. It's all just about setting the etcd endpoints in config as etcd hosts instead of M3DB hosts. See [these docs](/docs/v1.0/operational_guide/etcd#external-etcd) for more information on configuring an external `etcd` cluster.
...
Refer to the [troubleshooting guide](/docs/v1.0/faqs/troubleshooting).
...
Refer to the [Aggregation section](/docs/v1.0/how_to/query) of the M3Query how-to guide.
...
See the [Upgrading M3](/docs/v1.0/operational_guide/upgrading_m3) guide.
...
See our docs on the [/debug/dump api](/docs/v1.0/faqs/troubleshooting)
...
Refer to the [Namespace configuration guide](/docs/v1.0/operational_guide/namespace_configuration).
