...
{{% notice tip %}}
Below is the text file for the first node, copy and paste it into a new _.prom_ file in a directory named _node-1_, or [download the file](/docs/v1.0/includes/quickstart/node-1/metrics-1.prom) into that new folder.
{{% /notice %}}
...
{{% notice tip %}}
Below is the text file for the second node, copy and paste it into a new _.prom_ file in a directory named _node-2_, or [download the file](/docs/v1.0/includes/quickstart/node-2/metrics-2.prom) into that new folder.
{{% /notice %}}
...
{{% notice tip %}}
Below is the text file for the second node, copy and paste it into a new _.prom_ file in a directory named _node-3_, or [download the file](/docs/v1.0/includes/quickstart/node-3/metrics-3.prom) into that new folder.
{{% /notice %}}
