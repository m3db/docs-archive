...
-   _[{{% apiendpoint %}}prom/remote/write](/docs/v1.0/m3coordinator/api/remote/)_ - Write a Prometheus remote write query to M3DB with a binary snappy compressed Prometheus WriteRequest protobuf message.
