...
Once you've [installed](/docs/v1.2/operator/getting_started/installation) the M3DB operator and read over the [requirements](/docs/v1.2/operator/getting_started/requirements), you can start
...
pod's UID will be used for its [identity][pod-identity]. The cluster will have 1 [namespace](/docs/v1.2/operator/configuration/namespaces) that stores
...
[pod-identity]: /docs/v1.2/operator/configuration/pod_identity
[local-volumes]: https://kubernetes.io/blog/2018/04/13/local-persistent-volumes-beta/
[node-affinity]: /docs/v1.2/operator/configuration/node_affinity
