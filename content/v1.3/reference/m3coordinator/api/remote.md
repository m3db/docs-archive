...
Refer [here](https://prometheus.io/docs/v1.3/practices/remote_write/) for an up to date list of remote tuning parameters. 
...
For more details on querying data in PromQL that was written using this endpoint, see the [query API documentation](/docs/v1.3/reference/m3query/api/query).
